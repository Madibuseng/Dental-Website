  ...
  return (
    <div>
      ...
      <div className="text-center max-w-3xl mx-auto flex flex-col items-center">
        <h2 className="text-4xl  text-gray-800 p-4">Testimonials</h2>
        <img src="/divider.png" alt=""  className='pt-4'/>
        <p className="text-sm text-gray-800 mt-4 leading-relaxed"></p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6 max-w-6xl max-md:gap-16 max-md:max-w-lg mx-auto mt-20">
        <div className="w-full p-6 rounded-lg mx-auto shadow-[0_4px_14px_-6px_rgba(93,96,127,0.4)] bg-white relative">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-800 leading-relaxed">One of the best dental facilities iv ever visited and the service was superb.</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <h4 className="text-sm whitespace-nowrap font-bold">Stanford Mashau</h4>
          </div>
        </div>
        ...
        <div className="w-full p-6 rounded-lg mx-auto shadow-[0_4px_14px_-6px_rgba(93,96,127,0.4)] bg-white relative">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-800 leading-relaxed">Was an amazing experience, extracting my tooth my painless, swift procedure the Dr was very gentle.</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <h4 className="text-sm whitespace-nowrap font-bold">Thozama Mayezana</h4>
          </div>
        </div>
